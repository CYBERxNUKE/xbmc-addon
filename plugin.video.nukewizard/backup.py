...
def Backup():
    ...
    message_header = "Computertechs Installer is creating the backup..."
    message_header2 = "Computertechs Installer is creating the backup..."
    message1 = "Archiving..."
    message2 = ""
    message3 = ""
...
def FullBackup():
    ...
    exclude_files = ["spmc.log", "spmc.old.log", "xbmc.log", "xbmc.old.log", "kodi.log", "kodi.old.log", "fretelly.log",
                     "freetelly.old.log"]
    message_header = "Computertechs Installer Is Creating A  Full  Backup..."
    message_header2 = "Computertechs Installer Is Creating A  Full  Backup..."
    message1 = "Archiving..."
    message2 = ""
    message3 = ""
    FIX_SPECIAL(USERDATA)
...
def ADDON_DATA_BACKUP():
    ...
    exclude_dirs = ['']
    exclude_files = [""]
    message_header = "Computertechs Installer Is Creating Addon Data Backup..."
    message_header2 = "Computertechs Installer Is Creating Addon Data Backup..."
    message1 = "Archiving..."
    message2 = ""
    message3 = ""
