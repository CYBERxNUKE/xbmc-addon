...
AddonTitle ="Computertechs Installer"
import ssl
...
def uninstall_keymap():
	...
	dialog.ok("Indigo", "[B][COLOR white]Success, we have removed the keyboards.xml file.[/COLOR][/B]",'[COLOR white]Thank you for using Computertechs Installer[/COLOR]')
	#xbmc.executebuiltin("Container.Refresh")
