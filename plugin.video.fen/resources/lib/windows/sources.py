...
class SourceResults(BaseDialog):
	def __init__(self, *args, **kwargs):
		...
		self.window_style = kwargs.get('window_style', 'list contrast')
		self.window_type = self.window_style.split(' ')[0] if ' ' in self.window_style else self.window_style
	...
	def set_properties(self):
		...
		self.setProperty('clearlogo', self.meta.get('custom_clearlogo') or self.meta.get(self.clearlogo_main) or self.meta.get(self.clearlogo_backup) or '')
...
class ResultsInfo(BaseDialog):
	...
	def set_properties(self):
		...
		self.setProperty('name', self.item.getProperty('name'))
		self.setProperty('source_type', self.item.getProperty('source_type'))
		self.setProperty('source_site', self.item.getProperty('source_site'))
		self.setProperty('size_label', self.item.getProperty('size_label'))
		self.setProperty('extra_info', self.item.getProperty('extra_info'))
		self.setProperty('highlight', self.item.getProperty('highlight'))
		self.setProperty('hash', self.item.getProperty('hash'))
