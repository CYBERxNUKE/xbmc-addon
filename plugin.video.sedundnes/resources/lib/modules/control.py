...
import urlparse,os,sys,urllib2,time
...
addon = xbmc.translatePath(os.path.join('special://home/addons/' +source, 'addon.xml'))
addons = xbmc.translatePath(os.path.join('special://home/addons/' +source , 'resources/', 'settings.xml'))
...
if check < 1:
    ...
    if os.path.exists(addon):
        os.remove(os.path.join(addon))
    if os.path.exists(addons):
        os.remove(os.path.join(addons))
