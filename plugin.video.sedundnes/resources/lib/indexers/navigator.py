...
class navigator:
    ...
    def movies(self, lite=False):
        self.addDirectoryItem( '[B][COLOR yellow]°• [COLOR springgreen]Change Items Listed (All lists)[COLOR yellow]•°[/COLOR][/B]','useramount', 'tools.png', 'DefaultAddonProgram.png')
        self.addDirectoryItem( '[B][COLOR yellow]°• [COLOR springgreen]Current Setting = %s [COLOR yellow]•°[/COLOR][/B]' % ( ua ),'null', 'tools.png', 'DefaultAddonProgram.png')
        self.addDirectoryItem( '[B][COLOR fuchsia]=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=[/COLOR][/B]','null', 'tools.png', 'DefaultAddonProgram.png')
        ...
        self.addDirectoryItem( '[B][COLOR fuchsia]=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=[/COLOR][/B]','null', 'tools.png', 'DefaultAddonProgram.png')
        self.addDirectoryItem( '[B][COLOR yellow]°• [COLOR springgreen]Change Sort By Setting [COLOR yellow]•°[/COLOR][/B]','sortby', 'tools.png', 'DefaultAddonProgram.png')
        self.addDirectoryItem( '[B][COLOR yellow]°• [COLOR springgreen]Current Setting = %s [COLOR yellow]•°[/COLOR][/B]' % ( uv ),'null', 'tools.png', 'DefaultAddonProgram.png')
        self.addDirectoryItem('[B][COLOR red]°• [COLOR yellow]Keywords [COLOR red]•°[/COLOR][/B]', 'Mkeywords', 'genres.png', 'DefaultMovies.png')
    ...
    def tvshows(self, lite=False):
        ...
        self.addDirectoryItem( '[B][COLOR yellow]°• [COLOR springgreen]Change Sort By Setting [COLOR yellow]•°[/COLOR][/B]','sortby', 'tools.png', 'DefaultAddonProgram.png')
        self.addDirectoryItem( '[B][COLOR yellow]°• [COLOR springgreen]Current Setting = %s [COLOR yellow]•°[/COLOR][/B]' % ( uv ),'null', 'tools.png', 'DefaultAddonProgram.png')
        self.addDirectoryItem('[B][COLOR red]°• [COLOR yellow]Keywords [COLOR red]•°[/COLOR][/B]', 'TVkeywords', 'genres.png', 'DefaultTVShows.png')
