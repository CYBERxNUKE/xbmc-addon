...
logos_path = os.path.join(xbmc.translatePath('special://home/userdata/addon_data') , 'script.tvgomfg', 'extras', 'logos', LOGOS)
...
class Database(object):
        ...
        while True:
            ...
            try:
                ...
                if cancel_requested_callback is None:
                    ...
                    xbmc.log('[script.tvgomfg] Database is locked, retrying...', xbmc.LOGDEBUG)

            except sqlite3.DatabaseError:
                self.conn = None
                if self.alreadyTriedUnlinking:
                    xbmc.log('[script.tvgomfg] Database is broken and unlink() failed', xbmc.LOGDEBUG)
                    break
                else:
                    try:
    ...
    def _updateChannelAndProgramListCaches(self, date, progress_callback, clearExistingProgramList):
        ...
        c = self.conn.cursor()
        try:
            xbmc.log('[script.tvgomfg] Updating caches...', xbmc.LOGDEBUG)
...
class DIXIESource(Source):
    ...
    def GetDixieUrl(self):
        ...
        if dixieUrl == 'OFFSIDE':
            return 'http://computertechs.org/xbmc/omfgxml.php'
    ...
    def getCategories(self):
        ...
        url = 'http://computertechs.org/xbmc/omfg/cat.xml'
